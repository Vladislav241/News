...
(function(){
  ...
  function injectStyles(){
    ...
    s.textContent = `
      ...
      @media (max-width: 760px){.sharePromoCard{padding:14px}.sharePromoActions{flex-wrap:wrap;justify-content:flex-end}.sharePromoGrid{grid-template-columns:1fr}.sharePromoTop h3{font-size:24px}.sharePromoModal{padding:20px 18px 18px}}
    `;
